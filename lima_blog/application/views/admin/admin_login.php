...
<head>
	...
	<!-- end: Favicon -->
			...
			<style type="text/css">
			body { background: url(<?php echo base_url()?>asset/admin_asset/img/bg-login.jpg) !important; }
		</style>
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<form class="form-horizontal" action="admin/admin_login_check" method="post">
						<fieldset>
