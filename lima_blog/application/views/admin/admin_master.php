...
<head>
	...
	<!-- end: Favicon -->
		...
		<script type="text/javascript">
			function check_delete(category_name){
				var check=confirm("Are you sure to delete this?"+category_name);
				if(check){
					return true;
				}
				else{
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown hidden-phone">
							...
							<ul class="dropdown-menu messages">
                            	...
                            	<li>
                                    <a href="#">
										<span class="avatar"><img src="<?php echo base_url()?>asset/admin_asset/img/avatar.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Dennis Ji
										     </span>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="<?php echo base_url();?>index.php/Super_admin/Logout"><i class="halflings-icon off"></i> Logout</a></li>
							</ul>
						</li>
						<!-- end: User Dropdown -->
					</ul>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="<?php echo base_url()?>Super_admin/add_category"><i class="icon-envelope"></i><span class="hidden-tablet"> Add Category</span></a></li>
						<li><a href="<?php echo base_url()?>Super_admin/manage_category"><i class="icon-tasks"></i><span class="hidden-tablet">Manage Category</span></a></li>
						<li><a href="<?php echo base_url()?>super_admin/add_blog"><i class="icon-eye-open"></i><span class="hidden-tablet"> Add Blog</span></a></li>
						<li><a href="<?php echo base_url()?>super_admin/manage_blog"><i class="icon-dashboard"></i><span class="hidden-tablet"> Manage Blog</span></a></li>
						<li>
